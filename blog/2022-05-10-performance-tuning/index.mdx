...
description: Brendan Greggさんのブログで紹介されていたいくつかの方法論と自分が大事だと感じるパフォーマンスチューニングの3つのフェーズについて書いていきます。
authors: [tetsuzawa]
tags: [performance tuning, use method, tsa method, problem statement method, async-profiler]
keywords: [performance tuning, use method, tsa method, problem statement method, async-profiler]
image: ./instances.png
---

import Image from '@theme/IdealImage';
import instanceImg from './instances.png';

<Image img={instanceImg} alt={"the graph shows Number of instances"}/>
...
<Image alt="os model" img={require("./os_model.png")}/>
...
<Image alt="use_method" img={require("./use_method.png")}/>
...
<Image alt="tsa_method" img={require("./tsa_method.png")}/>
...
<Image alt="on-CPU sampling" img={require("./on-CPU sampling.png")}/>


一方で、wall-clockプロファイリングでは図のようにoff-CPUもサンプリングします。


<Image alt="wall-clock sampling" img={require("./wall-clock sampling.png")}/>
...
<Image alt="flamegraph_all" img={require("./flamegraph_all.png")}/>
...
<Image alt="flamegraph_doget" img={require("./flamegraph_doget.png")}/>
